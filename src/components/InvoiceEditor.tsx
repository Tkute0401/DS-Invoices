        ...
        <div className="relative w-[calc(100%+6rem)] border-t-8 border-black -mt-12 -ml-12 px-12 pt-12 pb-6 mb-8 flex flex-col">
          <div className="flex justify-between items-center mb-5">
            ...
            <div className="w-1/3 flex justify-center">
              <h1 className="text-4xl text-black font-black tracking-widest uppercase m-0">INVOICE</h1>
            </div>
            <div className="w-1/3 flex justify-end">
              <div className={`${paymentStatusColor} text-white px-3 py-1 text-[11px] font-bold uppercase tracking-widest rounded shadow-sm`}>{paymentStatus}</div>
            </div>
          </div>
